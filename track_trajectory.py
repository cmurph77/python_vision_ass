...
def track_trajectory(locations,video_width):
    ...
    for i in range(1, len(locations)):
        ...
        if current_vertical_direction == "up" and vertical_direction == "down":
            print("Frame: ", current_frame,current_point, "Bounce on Table")
        ...
        if current_horizontal_direction != horizontal_direction and horizontal_direction is not None:
            ...
            center_margin = 50
            if x_loc > video_width - center_margin and x_loc < video_width + center_margin  :  # changes direction in center - must be net
                print("Frame: ", current_frame,current_point, "Hit the Net")
            else:    
                print("Frame: ", current_frame,current_point, "Hit By player")
...
track_trajectory(ball_locations,960)